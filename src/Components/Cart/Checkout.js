...
const Checkout = (props) => {
  ...
  if (streetIsValid && postalIsValid && cityIsValid) {
    overallForm = true;
  }
    ...
    <form className={classes.form} onSubmit={submitFormHandler}>
      <div
        className={`${classes.control} ${
          streetIsNotValid ? classes.invalid : null
        }`}
      >
      ...
      <div
        className={`${classes.control} ${
          postalIsNotValid ? classes.invalid : null
        }`}
      >
      ...
      <div
        className={`${classes.control} ${
          cityIsNotValid ? classes.invalid : null
        }`}
      >
